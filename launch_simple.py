...
class FinancialAPIHandler(BaseHTTPRequestHandler):
    ...
    def send_root_response(self):
        ...
        response_data = {
            ...
            "cache_info": {"enabled": True, "ttl": "90 segundos", "strategy": "In-memory TTL (serverless)"},
        }
    ...
    def send_datos_resume_response(self, query):
        ...
        response_data = {
            ...
            "forex": [{"pair": "EUR/USD", "rate": "1.0950", "change": "+0.25%"}],
            "materias_primas": [{"symbol": "GC=F", "name": "Gold", "price": "2050.30", "change": "+0.75%"}],
            "etfs": [],
            "cripto": [],
    ...
    def send_scrape_response(self):
        ...
        response_data = {
            "data": {"finviz": {"indices": [], "acciones": []}, "yahoo": {"forex": [], "materias_primas": []}},
            "errors": [],
            "timestamp": time.time(),
            "sources_scraped": ["finviz", "yahoo"],
            "total_sources": 2,
    ...
    def send_404_response(self):
        ...
        response_data = {"detail": "Not Found", "status_code": 404, "message": f"Endpoint {self.path} no encontrado"}
