...
app = FastAPI(
    title="Financial Data API", description="API para obtener datos financieros de múltiples fuentes", version="2.0.0"
)
...
async def root(request: Request):
    ...
    return {
        ...
        "endpoints": {
            ...
            "especifico": {"/datos/{fuente}/{tipo}": "Datos específicos por fuente y tipo"},
        },
        "cache_info": {"enabled": True, "ttl": "5 minutos", "strategy": "Redis con fallback a memoria"},
    }
...
async def get_sources_info(request: Request):
    ...
    try:
        ...
        return {"sources": sources_info, "total_sources": len(sources_info)}
    except Exception as e:
